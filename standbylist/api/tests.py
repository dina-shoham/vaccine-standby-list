...
p3 = api.models.Patient(id =3, age = 69, firstName = "obama", lastName = "obama?idk his last name", 
             phoneNumber = "53463456", email = "obama@usa.us", 
             occupation = 'Tier 4', transport = 'Car', highRiskHousehold = True, 
             healthcareNum = "234161353", lat = 4.20, lon = 4.20, riskFactors = 3)
p3.save()

c1 = api.models.Clinic(lat = 37.3, lon = -25.0, name = "main clinic", email = "healthcare@vaccine", address = "ur moms house")
c1.save()
